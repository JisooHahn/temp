...
public class InviteService {
    ...
    public void sendInviteEmails(String[] emails, String role,
        ...
        String sender = "luna99954@gmail.com";
...
//        body.append("<img src='cid:logoImage' width='80' height='30' alt='로고' style='max-width: 100%; height: auto; vertical-align: top;' />");
        ...
        body.append("<tr><td style='height: 30px'></td></tr>");
        body.append("<tr><td style='padding-left: 20px; padding-right: 20px; display: flex; justify-content: center;'>");
        body.append("<a href=\"http://52.78.120.240:10000/enterprise/master-invite?code=" + code + "\" style='display: block; width: 70%; height: 40px; background-color: #00C853; text-align: center; line-height: 40px; color: white; font-weight: 700; text-decoration: none; border-radius: 2px; margin-bottom: 30px; padding: 15px;'>");
